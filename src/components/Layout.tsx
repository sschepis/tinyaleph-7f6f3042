...
const FULL_APP_PAGES = ['/sentient-observer', '/symbolic-mind', '/dna-computer', '/quantum-circuit', '/jam-partner', '/consciousness-resonator', '/sephirotic-oscillator', '/prime-resonance', '/quantum-wavefunction', '/entanglement-lab', '/bb84'];
