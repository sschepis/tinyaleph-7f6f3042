...
export const helpSteps = [
  ...
  },
  {
    ...
    content: 'Two primes form an entangled pair with composite Hamiltonian including twist coupling γ_pq(σ_z⊗σ_z) for non-local correlation.',
    icon: Link2
  },
  {
    title: 'Phase Synchronization',
    content: 'Communication succeeds when Δφ_q = arg(q_p*·q_q) < ε. Projection collapses states to eigenvalues ±√p representing symbolic meaning.',
    icon: Waves
  }
];
