...
import { invokeAlephChat } from '@/lib/ai-client';
...
const ChatExamples = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const { data, error } = await invokeAlephChat(
      ...
      if (error || !data?.content) {
        throw error || new Error('Empty response received from AI');
      }
      ...
      // Error toast already shown by invokeAlephChat
