...
const examples: ExampleConfig[] = [
  {
    id: 'hypercomplex',
    number: '1',
    title: 'Hypercomplex States',
    subtitle: 'Quaternions, Octonions, Sedenions',
    description: 'Explore hypercomplex number systems from 4D quaternions to 16D sedenions. These algebras provide the mathematical foundation for semantic state representation.',
    concepts: ['Sedenions', 'Non-commutative Algebra', 'Entropy', 'Norm'],
...
// e1 * e2 ≠ e2 * e1 (non-commutative!)`,
    codeTitle: 'core/01-hypercomplex.js',
  },
  {
    id: 'primes',
    number: '2',
    title: 'Prime Utilities',
    subtitle: 'Number theory foundations',
    description: 'Prime numbers form the basis of semantic encoding. Use these utilities for primality testing, factorization, and prime generation.',
    concepts: ['Primality Testing', 'Factorization', 'Prime Generation'],
...
console.log(factorize(n));  // Map { 2 -> 2, 3 -> 1, 5 -> 1 }

// Get all primes up to n
console.log(primesUpTo(n));  // [2, 3, 5, 7, 11, 13, ...]

// Get the nth prime
console.log(nthPrime(10));  // 29`,
    codeTitle: 'core/02-primes.js',
  },
];
...
const CoreExamplesPage = () => {
  return (
    <ExamplePageWrapper
      category="Core"
      title="Core Module"
      description="Hypercomplex algebra and prime number utilities - the mathematical foundations."
      examples={examples}
      exampleComponents={exampleComponents}
      previousSection={{ title: 'Crypto', path: '/crypto' }}
      nextSection={{ title: 'Physics', path: '/physics' }}
    />
  );
};
