...
import { Play, FileCode, GitMerge, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-lg font-semibold">Formal Type System</h3>
      </div>

      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            The type system: Nouns (N), Adjectives (A→N), 
  ...
  const runBetaReduction = useCallback(() => {
    const reductions: Record<string, Array<{ expr: string; rule: string }>> = {
      ...
      'τ(ChainTerm(ancient, wisdom))': [
        ...
        { expr: 'λx. encode([2,3,5], x) ⊗ [7,11]', rule: 'β-reduce' },
      ],
    };
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-lg font-semibold">Lambda Calculus & β-Reduction</h3>
      </div>
...
const examples: ExampleConfig[] = [
  {
    ...
    number: '1',
    title: 'Type System',
    subtitle: 'Formal type checking',
    description: 'The type system defines Nouns (N), Adjectives (A), Chains (A→N), and Fusions (N⊗N) with formal type inference and checking.',
    concepts: ['Type Inference', 'Algebraic Types', 'Formal Verification'],
...
console.log(checker.infer(ancientWisdom)); // N (Noun type)`,
    codeTitle: 'types/01-type-system.js',
  },
  {
    id: 'reduction',
    number: '2',
    title: 'Reduction Semantics',
    subtitle: 'Term normalization',
    description: 'The reduction system implements strong normalization. Every term reaches a unique normal form through finite reduction steps.',
    concepts: ['β-Reduction', 'Strong Normalization', 'Confluence'],
    code: `import { 
  ReductionSystem, 
  isNormalForm, 
  isReducible, 
...
console.log('Terminates:', proof.terminates);`,
    codeTitle: 'types/02-reduction.js',
  },
  {
    id: 'lambda',
    number: '3',
    ...
    concepts: ['Lambda Calculus', 'β-Reduction', 'τ-Translation'],
    code: `import { 
  tauTranslate,
  betaReduce,
  LambdaEvaluator,
...
const TypeSystemExamplesPage = () => {
  return (
    <ExamplePageWrapper
      ...
      title="Type System & Reduction"
      description="Formal logic concepts including type checking, reduction semantics, and lambda calculus translation."
      examples={examples}
